<html>
	...
	<div id="header">
		...
		<nav class="website-main-navigation">
			<span class="menu-item"><a href="lk-stud-info.php">Информация</a></span>
			<span class="menu-item"><a href="lk-stud-diplom.php">Диплом</a></span>
			<span class="menu-item"><a href="lk-stud-profile.php">Профиль</a></span>
		</nav>
		<div class="exit">
